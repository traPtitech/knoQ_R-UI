...
source_pointer:
  ...
  - path: src/features/room/mocks/factories.ts
    last_checked: 2026-09-18
  - path: tests/unit/relatedMockApi.spec.ts
    last_checked: 2026-09-18
...
- 開発モックの部屋は，基準日時の2日前と翌日から3日後までを用意する．過去・未来のカレンダー表示を確認できるようにし，期間指定のHTTP応答もテストする．
