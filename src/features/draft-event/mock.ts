...
export const mockDraftEvents: ResponseDraftEvent[] = [
  {
    ...
    status: 'open',
    admins: ['user-1'],
    invitees: ['user-2', 'user-3', 'user-4', '1eea935c-0d3c-411b-a565-1b09565237f4'],
...
const additionalMockDraftEvents: ResponseDraftEventDetail[] = [
  ...
  },
  {
    ...
    status: 'open',
    admins: ['user-2'],
    invitees: ['user-1', 'user-3', 'user-5', '1eea935c-0d3c-411b-a565-1b09565237f4'],
    createdAt: '2024-12-20T09:00:00.000Z',
    updatedAt: '2024-12-20T09:00:00.000Z',
    candidateSlots: [
      { slotId: 'slot-d3-1', timeStart: '2025-01-06T10:00:00', timeEnd: '2025-01-06T10:30:00' },
      { slotId: 'slot-d3-2', timeStart: '2025-01-06T10:30:00', timeEnd: '2025-01-06T11:00:00' },
      { slotId: 'slot-d3-3', timeStart: '2025-01-06T11:00:00', timeEnd: '2025-01-06T11:30:00' },
      { slotId: 'slot-d3-4', timeStart: '2025-01-07T10:00:00', timeEnd: '2025-01-07T10:30:00' },
      { slotId: 'slot-d3-5', timeStart: '2025-01-07T10:30:00', timeEnd: '2025-01-07T11:00:00' },
      { slotId: 'slot-d3-6', timeStart: '2025-01-07T11:00:00', timeEnd: '2025-01-07T11:30:00' }
    ],
    tags: [{ name: 'MTG' }]
  },
  {
    ...
    status: 'open',
    admins: ['user-3'],
    invitees: ['user-1', 'user-2', 'user-4', 'user-5', 'user-6', '1eea935c-0d3c-411b-a565-1b09565237f4'],
    createdAt: '2025-01-05T10:00:00.000Z',
    updatedAt: '2025-01-05T10:00:00.000Z',
    candidateSlots: [
      { slotId: 'slot-d4-1', timeStart: '2025-02-22T09:00:00', timeEnd: '2025-02-22T09:30:00' },
      { slotId: 'slot-d4-2', timeStart: '2025-02-22T09:30:00', timeEnd: '2025-02-22T10:00:00' },
      { slotId: 'slot-d4-3', timeStart: '2025-03-01T09:00:00', timeEnd: '2025-03-01T09:30:00' },
      { slotId: 'slot-d4-4', timeStart: '2025-03-01T09:30:00', timeEnd: '2025-03-01T10:00:00' },
      { slotId: 'slot-d4-5', timeStart: '2025-03-08T09:00:00', timeEnd: '2025-03-08T09:30:00' },
      { slotId: 'slot-d4-6', timeStart: '2025-03-08T09:30:00', timeEnd: '2025-03-08T10:00:00' }
    ],
    tags: [{ name: '合宿' }]
  },
  {
    ...
    candidateSlots: [
      { slotId: 'slot-d5-1', timeStart: '2025-01-25T14:00:00', timeEnd: '2025-01-25T14:30:00' },
      { slotId: 'slot-d5-2', timeStart: '2025-01-25T14:30:00', timeEnd: '2025-01-25T15:00:00' },
      { slotId: 'slot-d5-3', timeStart: '2025-01-26T14:00:00', timeEnd: '2025-01-26T14:30:00' },
      { slotId: 'slot-d5-4', timeStart: '2025-01-26T14:30:00', timeEnd: '2025-01-26T15:00:00' }
    ],
    tags: [{ name: 'LT' }]
  },
  {
    ...
    candidateSlots: [
      { slotId: 'slot-d6-1', timeStart: '2025-03-15T13:00:00', timeEnd: '2025-03-15T13:30:00' },
      { slotId: 'slot-d6-2', timeStart: '2025-03-15T13:30:00', timeEnd: '2025-03-15T14:00:00' },
      { slotId: 'slot-d6-3', timeStart: '2025-03-22T13:00:00', timeEnd: '2025-03-22T13:30:00' },
      { slotId: 'slot-d6-4', timeStart: '2025-03-22T13:30:00', timeEnd: '2025-03-22T14:00:00' }
    ],
    tags: []
  },
  {
    ...
    candidateSlots: [
      { slotId: 'slot-d7-1', timeStart: '2025-01-20T18:00:00', timeEnd: '2025-01-20T18:30:00' },
      { slotId: 'slot-d7-2', timeStart: '2025-01-20T18:30:00', timeEnd: '2025-01-20T19:00:00' }
    ],
    tags: []
  },
  {
    ...
    candidateSlots: [
      { slotId: 'slot-d8-1', timeStart: '2025-04-05T18:00:00', timeEnd: '2025-04-05T18:30:00' },
      { slotId: 'slot-d8-2', timeStart: '2025-04-05T18:30:00', timeEnd: '2025-04-05T19:00:00' },
      { slotId: 'slot-d8-3', timeStart: '2025-04-12T18:00:00', timeEnd: '2025-04-12T18:30:00' },
      { slotId: 'slot-d8-4', timeStart: '2025-04-12T18:30:00', timeEnd: '2025-04-12T19:00:00' }
    ],
    tags: [{ name: '歓迎会' }]
  },
  {
    ...
    status: 'confirmed',
    admins: ['user-3'],
    invitees: ['1eea935c-0d3c-411b-a565-1b09565237f4', 'user-1', 'user-2', 'user-5'],
    createdAt: '2025-01-20T08:00:00.000Z',
    updatedAt: '2025-02-25T15:00:00.000Z',
    candidateSlots: [
      { slotId: 'slot-d9-1', timeStart: '2025-03-15T10:00:00', timeEnd: '2025-03-15T10:30:00' },
      { slotId: 'slot-d9-2', timeStart: '2025-03-15T10:30:00', timeEnd: '2025-03-15T11:00:00' },
      { slotId: 'slot-d9-3', timeStart: '2025-03-22T10:00:00', timeEnd: '2025-03-22T10:30:00' },
      { slotId: 'slot-d9-4', timeStart: '2025-03-22T10:30:00', timeEnd: '2025-03-22T11:00:00' }
    ],
    tags: [{ name: 'ハッカソン' }]
  }
]
